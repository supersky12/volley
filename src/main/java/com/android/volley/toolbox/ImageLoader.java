...
public class ImageLoader {
    ...
    public static ImageListener getImageListener(final ImageView view,
        ...
        return new ImageListener() {
            @Override
            public void onFinishedBackground(Object result) {
     ...
     */
    public interface ImageListener extends Response.DeliverResponseListener {
        /**
    ...
    protected Request<Bitmap> makeImageRequest(String requestUrl, int maxWidth, int maxHeight,
        ...
        return new ImageRequest(requestUrl, new Response.DeliverResponseListener<Bitmap>() {
            @Override
            public void onFinishedBackground(Bitmap result) {
