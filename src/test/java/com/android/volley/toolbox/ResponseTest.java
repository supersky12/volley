...
public class ResponseTest {
    ...
    public void publicMethods() throws Exception {
        ...
        assertNotNull(Response.DeliverResponseListener.class.getDeclaredMethod("onResponse", Object.class));

        assertNotNull(Response.DeliverResponseListener.class.getDeclaredMethod("onErrorResponse",
                VolleyError.class));
