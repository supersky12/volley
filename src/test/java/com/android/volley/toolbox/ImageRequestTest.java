...
public class ImageRequestTest {
    ...
    public void publicMethods() throws Exception {
        ...
        assertNotNull(ImageRequest.class.getConstructor(String.class, Response.DeliverResponseListener.class,
                int.class, int.class, Bitmap.Config.class, Response.DeliverResponseListener.class));
        assertNotNull(ImageRequest.class.getConstructor(String.class, Response.DeliverResponseListener.class,
